...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['events'])) {
    ...
    copy(PATH_EVENTS_JSON, $backupFilename);
    file_put_contents(PATH_EVENTS_JSON, json_encode($events, JSON_PRETTY_PRINT));
...
<body>
    ...
    <script>
        ...
        async function fetchEvents() {
            const response = await fetch('<?php echo URL_DATA_ROOT; ?>/events/events.json');
        ...
        function downloadEvents() {
            ...
            link.download = 'data/events/events.json';
            link.click();
        }
