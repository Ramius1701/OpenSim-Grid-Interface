...
<style>
.daily-updates-list { list-style: none; padding: 0; margin: 0; }
.daily-update-item { margin: .25rem 0 .5rem; }
.daily-update-item .time { opacity: .75; }
.daily-update-item .desc { margin-top: .25rem; }
.type-badge { display:inline-block; font-size: .75rem; padding: .1rem .35rem; border-radius: .25rem;
              background: #eef; color: #223; margin-right: .35rem; vertical-align: baseline; }
</style>
