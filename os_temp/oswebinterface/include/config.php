...
// Seitenadressen
// Website addresses
define('BASE_URL', 'http://localhost'); // Basis-URL der Webseite / Base URL of the website
define('SITE_NAME', 'OpenSim Grid'); // Name des Grids / Name of the grid

// Konfigurationsoptionen Standard Template:
// Template configuration options:
// "headerBlanc.php", "headerST.php", "headerW3.php", "headerBT5.php", "headerFoundation.php", "headerMaterialize.php", "headerTailwind.php",  "headerPrimer.php", "headerTachyons.php", "headerSpectre.php", "headerTent.php", "headerModern.php"
define('HEADER_FILE', 'headerModern.php'); // Ändere diesen Wert, um die verschiedenen Template-Header-Dateien zu laden. / Change this value to load different template header files.
