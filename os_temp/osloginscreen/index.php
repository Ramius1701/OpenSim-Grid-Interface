...
<div class="text-center footer copyright medium">
    <?php
		$last_modification="Last modified: " . date ("l\, F d\, Y \- H:i:s A", getlastmod());
    ...
    <?php } ?> - Content Copyright &#169; 2008 - <?php echo date("Y"); ?>
</div>
