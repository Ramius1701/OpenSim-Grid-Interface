        ...
        <div class="col-md-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-search"></i> Search groups</h5>
                </div>
                <div class="card-body">
                    <form method="GET" action="groups.php">
                        ...
                        <a href="groups.php" class="btn btn-secondary w-100 mt-2">
                            <i class="bi bi-arrow-repeat"></i> Show all
                        </a>
                    </form>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="groups.php?action=list" class="btn btn-outline-primary btn-sm">
                            <i class="bi bi-list-ul"></i> All groups
                        </a>
                        ...
                        <a href="groups.php?action=open" class="btn btn-outline-info btn-sm">
                            <i class="bi bi-door-open"></i> Open groups
                        </a>
                        <a href="groups.php?action=popular" class="btn btn-outline-warning btn-sm">
                            <i class="bi bi-fire"></i> Popular groups
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-bar-chart"></i> Group statistics</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-9">
            <?php if ($action == 'view' && $groupId): ?>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="info">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h5 class="mb-0">Group charter:</h5>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="card bg-light">
                                            <div class="card-body text-center">
                                                ...
                                                <button class="btn btn-warning" onclick="requestInvite('<?php echo $groupId; ?>')">
                                                    <i class="bi bi-envelope"></i> Request invite
                                                </button>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card mt-3">
                                            <div class="card-header">
                                                <h6><i class="bi bi-pie-chart-fill"></i> Group statistics</h6>
                                            </div>
                                            <div class="card-body">
                                                <?php
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <p class="text-primary mb-2">
                                                    <i class="bi bi-person-badge"></i> <?php echo htmlspecialchars($member['Title']); ?>
                                                </p>
                                                <?php endif; ?>
                                                
                                                <?php if ($member['Contribution']): ?>
                                                <p class="text-success mb-2">
                                                    <i class="bi bi-coin"></i> Contribution: L$ <?php echo number_format($member['Contribution'], 0, ',', '.'); ?>
                                                </p>
                                                <?php endif; ?>
                            ...
                            <div class="tab-pane fade" id="invites">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <h5 class="mb-0">No open invitations</h5>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <div class="alert alert-warning">
                    <i class="bi bi-exclamation-triangle"></i> Group not found.
                </div>
                <?php endif; ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php if ($group['Title']): ?>
                                        <p class="text-primary mb-2">
                                            <i class="bi bi-person-badge"></i> <?php echo htmlspecialchars($group['Title']); ?>
                                        </p>
                                        <?php endif; ?>
                        ...
                        <div class="text-center py-5">
                            ...
                            <h5 class="mb-0">No group memberships</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center py-5">
                            ...
                            <h5 class="mb-0">No open groups</h5>
