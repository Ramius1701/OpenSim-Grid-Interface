...
<?php endif;?>
      ...
      <div class="card"><div class="card-header"><h6 class="mb-0"><i class="bi bi-palette me-1"></i> Legend</h6></div><div class="card-body small">
        <div class="legend">
          ...
          <div class="item"><span class="swatch" style="background:<?=$C_CENTER?>"></span> Grid Centre</div>
        </div>
      </div></div>
    </div><!-- /col-md-3 -->
    ...
    <div class="col-md-9">
      <div class="card"><div class="card-header d-flex justify-content-between align-items-center">
        <div><h5 class="mb-0"><i class="bi bi-grid-3x3-gap me-1"></i> Map</h5><div class="small text-muted">
          Centre: <strong><?=htmlspecialchars("$cx,$cy")?></strong> ·
