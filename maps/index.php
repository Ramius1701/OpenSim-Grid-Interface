    ...
    '<main class="cp-map-page" aria-label="%s World Map">
        <div class="cp-map-toolbar">
            ...
            <div class="cp-map-actions">
                <a href="<?php echo BASE_URL; ?>/maps/gridmap.php" class="cp-map-btn" title="Tile-grid view - browse and teleport by region">Grid Map</a>
                <a href="<?php echo BASE_URL; ?>/gridstatus.php" class="cp-map-btn">Grid Status</a>
