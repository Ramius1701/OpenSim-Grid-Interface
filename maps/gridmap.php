  ...
  <div class="row">
    <div class="col-md-3">
      <div class="card mb-3"><div class="card-body py-2 d-flex gap-2 flex-wrap">
        <a href="<?php echo BASE_URL; ?>/maps/" class="btn btn-sm btn-outline-secondary flex-fill" title="Satellite-style map - pan, zoom, and search visually"><i class="bi bi-globe me-1"></i>World Map</a>
        <a href="<?php echo BASE_URL; ?>/gridstatus.php" class="btn btn-sm btn-outline-secondary flex-fill"><i class="bi bi-activity me-1"></i>Grid Status</a>
      </div></div>
